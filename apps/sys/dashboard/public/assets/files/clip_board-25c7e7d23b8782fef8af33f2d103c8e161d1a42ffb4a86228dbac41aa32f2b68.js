...
jQuery(function() {
  ...
  $(CONTENTID).on(EVENTNAME4.renameFilePrompt, function(e, options) {
    fileOps.renameFilePrompt(options.file);
  });
  $(CONTENTID).on(EVENTNAME4.renameFile, function(e, options) {
    fileOps.renameFile(options.files, options.result.value);
  });
  $(CONTENTID).on(EVENTNAME4.createFile, function(e, options) {
    fileOps.newFile(options.result.value);
  });
  $(CONTENTID).on(EVENTNAME4.createDirectory, function(e, options) {
    fileOps.newDirectory(options.result.value);
  });
  $(CONTENTID).on(EVENTNAME4.download, function(e, options) {
  ...
  $(CONTENTID).on(EVENTNAME4.deletePrompt, function(e, options) {
  ...
  $(CONTENTID).on(EVENTNAME4.deleteFile, function(e, options) {
    fileOps.delete(options.files, options.from_fs);
  });
  $(CONTENTID).on(EVENTNAME4.moveFile, function(e, options) {
    fileOps.move(options.files, options.token, options.from_fs, options.to_fs);
  });
  $(CONTENTID).on(EVENTNAME4.copyFile, function(e, options) {
  ...
  $(CONTENTID).on(EVENTNAME4.changeDirectory, function(e, options) {
...
jQuery(function() {
  ...
  $(CONTENTID).on(EVENTNAME3.clearClipboard, function(e, options) {
    clipBoard.clearClipboard();
    clipBoard.updateViewForClipboard();
  });
  $(CONTENTID).on(EVENTNAME3.updateClipboard, function(e, options) {
    if (options.selection.length == 0) {
      const eventData = {
  ...
  $(CONTENTID).on(EVENTNAME3.updateClipboardView, function(e, options) {
    clipBoard.updateViewForClipboard();
  });
});
var ClipBoard = class {
 ...
 */
//# sourceMappingURL=/pun/sys/dashboard/assets/files/clip_board.js-bedb2601e882f659ffe33ef35ee8738fbae5df4c61ff6b4e1d22fd1b42275a80.map
//!
;
